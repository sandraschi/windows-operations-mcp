...
@tool(
    ...
    parameters={
        ...
        "event_source": {"type": "string", "description": "Filter by event source"},
        ...
        "time_range_hours": {"type": "integer", "description": "Query events from the last N hours", "default": 24},
        "max_events": {"type": "integer", "description": "Maximum number of events to return", "default": 100},
    },
    required=["log_name"],
    returns={
        "type": "object",
...
@tool(
    ...
    parameters={
        "log_name": {"type": "string", "description": "Name of the event log to export", "default": "Application"},
        "output_file": {"type": "string", "description": "Path where to save the exported log"},
        "format": {"type": "string", "description": "Export format (csv, json, txt)", "default": "csv"},
        "time_range_hours": {"type": "integer", "description": "Export events from the last N hours", "default": 24},
        "event_source": {"type": "string", "description": "Filter by event source"},
    ...
    try:
        ...
        if format.lower() == "csv":
            ...
            with open(output_file, "w", encoding="utf-8") as txtfile:
                txtfile.write("Windows Event Log Export\n")
...
@tool(
    ...
    parameters={
        "log_name": {"type": "string", "description": "Name of the event log to clear", "default": "Application"},
        "backup_before_clear": {"type": "boolean", "description": "Create a backup before clearing", "default": True},
        "backup_file": {"type": "string", "description": "Path for backup file (if backup_before_clear is True)"},
    },
    required=["log_name"],
    returns={
        "type": "object",
...
def clear_windows_event_log(
    log_name: str = "Application", backup_before_clear: bool = True, backup_file: str | None = None
) -> dict[str, Any]:
    """
...
@tool(
    ...
    parameters={
        "log_name": {"type": "string", "description": "Name of the event log to monitor", "default": "Application"},
        "event_source": {"type": "string", "description": "Monitor only events from this source"},
        "event_id": {"type": "integer", "description": "Monitor only this specific event ID"},
        "event_type": {"type": "string", "description": "Monitor only this event type"},
        "monitor_duration": {"type": "integer", "description": "How long to monitor (seconds)", "default": 300},
        "check_interval": {
            "type": "integer",
...
def register_windows_event_log_tools(mcp):
    ...
    logger.info(
        "windows_event_log_tools_registered",
        tools=[
