...
def is_text_file(filepath: str | Path, chunk_size: int = 4096) -> bool:
    """
...
def create_backup(filepath: str | Path, backup_dir: str | Path | None = None) -> Path:
    """
...
def normalize_line_endings(content: str, line_ending: str | None = None) -> str:
    """
