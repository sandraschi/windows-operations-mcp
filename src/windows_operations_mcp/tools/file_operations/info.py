...
def calculate_file_hash(file_path: Path, algorithm: str = "sha256", chunk_size: int = 65536) -> str:
    ...
    try:
        ...
        raise FileOperationError(f"Failed to calculate hash: {e!s}") from e
...
def list_directory(
    ...
    try:
        ...
        raise FileOperationError(f"Failed to list directory: {e!s}") from e
...
def get_file_info_tool(
    file_path: str, include_content: bool = False, include_metadata: bool = True, include_attributes: bool = True
) -> dict[str, Any]:
    """
