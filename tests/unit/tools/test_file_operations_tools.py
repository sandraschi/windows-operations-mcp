...
class TestFileOperationsTools(unittest.TestCase):
    ...
    def test_write_file_basic(self):
        ...
        result = write_file_func(path=new_file, content="New file content")
    ...
    def test_write_file_with_overwrite(self):
        ...
        result = write_file_func(path=self.test_file, content="Overwritten content", overwrite=True)
    ...
    def test_move_file_basic(self):
        ...
        result = move_file_func(source=self.test_file, destination=new_location)
    ...
    def test_copy_file_basic(self):
        ...
        result = copy_file_func(source=self.test_file, destination=copy_location)
    ...
    def test_list_directory_with_pattern(self):
        ...
        result = list_directory_func(directory_path=self.test_dir, pattern="*.txt")
    ...
    def test_create_directory_with_parents(self):
        ...
        result = create_directory_func(directory_path=new_dir, create_parents=True)
    ...
    def test_move_directory_basic(self):
        ...
        result = move_directory_func(source_path=dir_to_move, destination_path=new_location)
    ...
    def test_copy_directory_basic(self):
        ...
        result = copy_directory_func(source_path=dir_to_copy, destination_path=copy_location)
    ...
    def test_write_file_without_overwrite(self):
        ...
        result = write_file_func(path=self.test_file, content="New content", overwrite=False)
