...
from windows_operations_mcp import decorators, logging_config
...
class TestComprehensive(unittest.TestCase):
    ...
    def test_utils_functionality(self):
        ...
        test_result = {"success": True, "stdout": "test output", "stderr": "", "exit_code": 0, "execution_time": 1.5}
    ...
    def test_archive_tools_functionality(self):
        ...
        result = archive_tools.create_archive(archive_path=archive_path, source_paths=[test_file1, test_file2])
        self.assertIn("success", result)
    ...
    def test_file_operations_functionality(self):
        ...
        result = file_operations.write_file(path=new_file, content="New content")
        self.assertIn("path", result)
        ...
        result = file_operations.copy_file(source=test_file, destination=copy_file)
        self.assertIn("success", result)
