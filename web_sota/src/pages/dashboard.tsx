			...
			<div className="space-y-1 mt-6">
				...
				<div className="flex items-baseline gap-2">
					...
					{typeof progress === "number" && (
						<span className="text-[10px] font-bold px-1.5 py-0.5 rounded-md bg-white/5 border border-white/5">
							LIVE
						</span>
					)}
				</div>
					...
					<div className="flex justify-between items-center mb-8">
						<div>
							...
							<p className="text-xs text-muted-foreground font-medium mt-1">
								Resource intensive applications currently execution
							</p>
						</div>
						<button className="text-[10px] font-bold uppercase tracking-widest px-4 py-2 rounded-full border border-white/10 hover:bg-white/5 transition-colors">
							View All
						</button>
					</div>
				...
				<div className="space-y-6">
					<div className="glass-card rounded-[2.5rem] p-8 border-primary/20 bg-primary/5">
						...
						<p className="text-xs text-muted-foreground leading-relaxed mb-6">
							System health monitoring and automated recovery routines are
							currently active.
						</p>
					...
					<div className="glass-card rounded-[2.5rem] p-8">
						...
						<div className="grid grid-cols-2 gap-3">
							{["Kill High CPU", "Clear Temp", "Net Reset", "Dev Mode"].map(
								(action) => (
									<button
										key={action}
										className="p-4 rounded-2xl bg-white/5 border border-white/5 hover:border-primary/30 hover:bg-primary/5 text-[10px] font-bold text-muted-foreground hover:text-primary transition-all text-center"
									>
										{action}
									</button>
								),
