            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Automation Engineering</span>
                    </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                    ...
                    >
                        <div>
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <Badge variant="outline" className="bg-green-500/10 text-green-400 border-green-500/20 text-[10px] font-black tracking-widest px-3 py-1">
                                    READY_TO_DEPLOY
                                </Badge>
                            </div>
                            ...
                            <p className="text-xs text-muted-foreground/80 leading-relaxed max-w-sm">
                                {workflow.description || "Standardized system orchestration protocol for continuous Windows environment stability."}
                            </p>
                        </div>
                        ...
                        <div className="mt-8 space-y-6">
                            ...
                            <button className="w-full flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-white/20 transition-all group/btn group-hover:shadow-lg ">
                                <span className="flex items-center gap-3">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground">Execute Protocol</span>
                                </span>
                ...
                {(!workflows?.workflows || workflows.workflows.length === 0) && !isLoading && (
                    <div className="md:col-span-2 py-32 glass-card rounded-[3rem] border-dashed border-2 flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-2xl font-black italic tracking-tighter opacity-50 uppercase">No Protocols Compiled</h3>
                        <p className="text-xs text-muted-foreground mt-2 max-w-xs leading-relaxed font-medium">Create a new mission protocol to begin automated Windows orchestration.</p>
                        <Button variant="outline" className="mt-8 rounded-xl border-white/10 text-[10px] font-black uppercase tracking-widest px-8">
                            Browse Templates
                        </Button>
                    </div>
                )}
