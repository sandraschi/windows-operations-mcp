    ...
    return (
        <aside className="w-64 glass h-screen flex flex-col p-4 z-50 sticky top-0">
            <div className="flex items-center space-x-3 px-2 py-6 mb-6">
                ...
                <div>
                    <h1 className="font-extrabold text-lg tracking-tight leading-none vibrant-text">Windows</h1>
                    <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold mt-1">Operations SOTA</p>
                </div>
            </div>

            <div className="flex-1 space-y-1">
                <p className="text-[10px] font-bold text-muted-foreground px-3 mb-2 uppercase tracking-widest">Main Menu</p>
                {navItems.map((item) => {
            ...
            <div className="mt-auto space-y-4">
                ...
                <div className="flex items-center gap-3 px-3 py-4 border-t border-white/5">
                    <div className="w-8 h-8 rounded-full bg-primary/20 border border-primary/50 flex items-center justify-center text-[10px] font-bold text-primary">SS</div>
                    <div className="flex flex-col">
                        <span className="text-xs font-bold leading-none">Sandra S.</span>
                        <span className="text-[10px] text-muted-foreground mt-0.5">Administrator</span>
                    </div>
                </div>
            </div>
        </aside>
