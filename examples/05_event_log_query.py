...
from windows_operations_mcp.tools.windows_event_logs import list_event_log_providers, query_windows_event_log
...
def main():
    ...
    result = query_windows_event_log(log_name="System", max_events=10, level="Error,Warning")
    ...
    result = query_windows_event_log(log_name="Application", max_events=5, level="Error")
    ...
    result = query_windows_event_log(
        log_name="Security", max_events=10, start_time=yesterday.isoformat(), end_time=now.isoformat()
    )
    ...
    result = query_windows_event_log(log_name="Security", event_id=4624, max_events=5)
